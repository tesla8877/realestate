...
class MainActivityViewModel(
    ...
    override fun resultToViewState(result: LoadingContentError<MainActivityResult>){
    ...
    private fun onOpenAddPropertyRequest(){
        ...
        searchAgentsJob = launch {
            ...
            val result: LoadingContentError<MainActivityResult> = if(agents == null || agents.isEmpty()){
                LoadingContentError.Error(MainActivityResult.OpenAddPropertyResult)
            } else{
                LoadingContentError.Content(MainActivityResult.OpenAddPropertyResult)
            }
    ...
    private fun emitCurrentCurrency(){
        ...
        val result: LoadingContentError<MainActivityResult> = LoadingContentError.Content(MainActivityResult.ChangeCurrencyResult(currency))
    ...
    private fun emitResultNetworkRequestFailure(error: ErrorSourceMainActivity){
        val result: LoadingContentError<MainActivityResult> = LoadingContentError.Error(
    ...
    private fun createNewDataInDBLocally(){
        ...
        createPropertiesAndDataJob = launch {
            ...
            val result: LoadingContentError<MainActivityResult> = LoadingContentError.Content(
