...
import com.openclassrooms.realestatemanager.view.addProperty.PickDateDialogView
    ...
    private fun renderErrors(errors: List<ErrorSourceSearch>){
        ...
        errors.forEach {
            when(it){
                ...
                ErrorSourceSearch.WRONG_DATE_FORMAT -> onMarketLayout.error = getString(R.string.has_to_be_in_format_date)
            }
