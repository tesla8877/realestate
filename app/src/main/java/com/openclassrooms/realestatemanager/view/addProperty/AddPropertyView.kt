...
class AddPropertyView : BaseFragmentRealStateManager(), RealStateManagerView<AddPropertyViewState>,
    ...
    @BindView(R.id.add_property_view_soldon_input_layout) lateinit var soldOnLayout: TextInputLayout
    ...
    @BindView(R.id.add_property_view_neighbourhood_input_layout) lateinit var neighbourhoodLayout: TextInputLayout
    @BindView(R.id.add_property_view_since_input_layout) lateinit var onMarketSinceLayout: TextInputLayout
    @BindView(R.id.add_property_view_dropdown_agent_input_layout) lateinit var agentLayout: TextInputLayout
    @BindView(R.id.add_property_view_type_input_layout) lateinit var typeLayout: TextInputLayout
    ...
    private fun renderDataFetchedProperty(type: String, price: Double?,
                                          ...
                                          amenities: List<TypeFacility>, agentFirstName: String,
